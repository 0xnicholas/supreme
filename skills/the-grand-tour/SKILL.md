---
name: the-grand-tour
description: Use at any stage of the entrepreneurial journey as a comprehensive reference — to find the right skill for your current situation, discover frameworks for the challenge you're facing, or revisit the foundational principles of building a business. This is the map of the entire territory, not a single path.
---
...
| 你的状态 | 使用什么 | 得到什么 |
|----------|----------|----------|
| 团队变大，决策变慢 | *Know-How* | 系统 vs 流程 vs 文化 |
| 品牌怎么建 | *Laws of Branding* | 定位、品类、心智 |
...
```dot
digraph grand_tour_nav {
    "我有什么？" [shape=diamond];
    "一个模糊的想法" [shape=box style=filled fillcolor=lightyellow];
    "一个有方向的方案" [shape=box style=filled fillcolor=lightyellow];
    "一个有 PMF 的产品" [shape=box style=filled fillcolor=lightyellow];
    "一个需要融资的计划" [shape=box style=filled fillcolor=lightyellow];

    "start-with-why" [shape=box style=filled fillcolor=lightblue];
    "pmf-driven" [shape=box style=filled fillcolor=lightblue];
    "challenge-me" [shape=box style=filled fillcolor=lightblue];
    "dark-forest" [shape=box style=filled fillcolor=lightblue];
    "show-me-the-money" [shape=box style=filled fillcolor=lightblue];
    "The Grand Tour" [shape=box style=filled fillcolor=lightgreen];

    "我有什么？" -> "一个模糊的想法";
    "我有什么？" -> "一个有方向的方案";
    "我有什么？" -> "一个有 PMF 的产品";
    "我有什么？" -> "一个需要融资的计划";
    "我有什么？" -> "不确定自己在哪" [label="以上都不是/都有"];

    "一个模糊的想法" -> "start-with-why";
    "一个模糊的想法" -> "pmf-driven";

    "一个有方向的方案" -> "challenge-me";
    "一个有方向的方案" -> "dark-forest";

    "一个有 PMF 的产品" -> "dark-forest";
    "一个有 PMF 的产品" -> "pmf-driven" [label="持续测量"];

    "一个需要融资的计划" -> "show-me-the-money";

    "不确定自己在哪" -> "The Grand Tour";
}
```
...
每一个成功的公司，在某个阶段都被所有人否定过。Airbnb 被 YC 拒绝了一次，被所有投资人拒绝过。Airbnb 第一年的收入是 200 美元/周。Founders Fund 投 Airbnb 的时候，Peter Thiel 说"这个公司估值太高，但你们非要投就投吧"。
